...
- 如果你是离线玩家，将游戏ID更改为 `Blake` 即可使用主角布莱克的皮肤
- 如果你是第三方外置登录，请参考所使用的皮肤站的对应教程（[LittleSkin教程](https://manual.littlesk.in/newbee/mod#skinport)）

::: tip
在离线模式的情况下，可以将以**自己游戏ID命名**的皮肤文件放在游戏根目录 `/cachedImages/skins` 中，启动游戏即可使用自己的皮肤！
:::

### :[twemoji:red-question-mark]:亡灵战争手机版？手机版移植？
- 官方从来没有制作手机版的打算，也不会去做兼容。
...
- 首先，记住自己现在的坐标，然后传送至技能电路处：
  ...
  /tp @a -1920 76 25
  ```
- 按照告示牌的指引操作，使用**技能点箱子**处的**对应灵魂石**，最后再传送回到自己的地方~
:::
