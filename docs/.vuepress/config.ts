...
`,
    ...
    social:[
          ...
          { icon: 'qq', link: 'https://qm.qq.com/q/LIgHWqCH6K'},
          { icon: 'bilibili', link: 'https://space.bilibili.com/40074868'},
          { icon: 'simple-icons:afdian', link: 'https://afdian.com/a/davidblackcn'},
        ],
    navbarSocialInclude: ['github','qq','bilibili','simple-icons:afdian'],
